...
\section{Experiments}
\subsection{Registered sequence}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.98\linewidth]{figures/experiment_evidence_map.pdf}
\caption{Registered studies are ordered so that baseline validity and strong controls precede mechanism expansion. The failed QN-000024 run remains in the registry rather than being erased.}
\label{fig:experiment_evidence_map}
\end{figure}

\subsection{Experiment Zero}
...
\subsection{Orthogonal tasks and acquisition}
...
\subsection{Computational-law and ablation suites}
...
\subsection{Probe, training-law, and trajectory studies}
...
\subsection{Metrics and multiplicity}
...
\subsection{Hardware and resource scope}
