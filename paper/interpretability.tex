...
\section{Interpretability and state audit}
\subsection{Frozen factor probes}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.98\linewidth]{figures/observable_probe.pdf}
\caption{Mechanism, localization, temporality, and context are decodable from several frozen states. GRU and state-space controls are at least as strong as the complex operator, refuting unique hierarchical interpretability.}
\label{fig:observable_probe}
\end{figure}

\subsection{Evidence-level trajectories}
...
\input{tables/trajectory_metrics.tex}

\subsection{Failure-case interpretation}
