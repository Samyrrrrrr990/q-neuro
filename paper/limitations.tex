...
\section{Limitations}
\subsection{Synthetic evidence and external validity}
...
\subsection{Reduced comparator and search envelope}
...
\subsection{Incomplete compute matching}
...
\subsection{Missing raw predictions}
...
\subsection{Outcome ineligibility}
...
\subsection{Investigator and replication limits}
...
\subsection{What the result does not falsify}
